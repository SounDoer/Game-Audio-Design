...
const toolLinks = {
  ...
  LibTV: 'https://www.liblib.tv/canvas',
  updream: 'https://www.updream.cn',
  HappyHorse: 'https://www.happyhorse.cn',
  ...
  'TapTap Maker': 'https://www.taptap.cn/tap-maker',
  AstrBot: 'https://github.com/AstrBotDevs/AstrBot',
  OpenClaw: 'https://github.com/openclaw/openclaw',
  'laper.ai': 'https://www.laper.ai',
  'V2-fun': 'https://v2fun.art',
  HappyOyster: 'https://www.happyoyster.com',
  Holopix: 'https://holopix.cn/home',
  Tripo: 'https://www.tripo3d.ai',
  'FLUX.2': 'https://bfl.ai/models/flux-2',
  Seedream: 'https://seed.bytedance.com/zh/seedream4_0',
