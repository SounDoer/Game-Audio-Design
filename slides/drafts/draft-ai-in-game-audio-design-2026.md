...
| 5 | 展示国内 AI 语音典型 | Qwen Voice：国内语音模型案例 | 国内模型进展、中文 TTS、语音克隆、变声 / 声线转换、可能的角色对白和本地化用途 | TODO(user): Qwen 系列语音模型材料；当前先以文字 placeholder 保留位置 | tool-focus | 后续由用户补充具体模型、链接、案例；本轮不编写未核验细节 | placeholder |
...
|------|----------------|-------------|--------|
| 语音 AI 工具 / 案例截图 | `slides/public/ai-in-game-audio-design-2026/elevenlabs-home-01.png`；`slides/public/ai-in-game-audio-design-2026/elevenlabs-home-02.png` | TBD: 用户补充 Qwen 系列语音模型与案例材料 | partial |
