...
![Room & Portal vs. Acoustics Simulation](ProjectAcoustics_RoomPortalAcousticsSimulation.png)
...
![Project Acoustics Plugin Integration](ProjectAcoustics_PluginIntegration.png)
...
![Project Acoustics Bake Process - Objects](ProjectAcoustics_BakeProcess_Objects.png)

2. Materials  
被标记对象使用到的所有 Materials 在此列出，根据需要选择材质吸声预设或者自定义数值，数值越大吸声效果越明显，混响效果也相应越少。预设中的数值参考自真实材料的吸声属性。
![Project Acoustics Bake Process - Materials](ProjectAcoustics_BakeProcess_Materials.png)
...
![Project Acoustics Bake Process - Probes](ProjectAcoustics_BakeProcess_Probes.png)
...
![Project Acoustics Bake Process - Bake](ProjectAcoustics_BakeProcess_Bake.png)
...
![Project Acoustics Design Control](ProjectAcoustics_DesignControl.png)
...
![Project Acoustics Reverb Effect](ProjectAcoustics_ReverbEffect.png)
...
![Project Acoustics Dynamic Portal](ProjectAcoustics_DynamicPortal.png)
