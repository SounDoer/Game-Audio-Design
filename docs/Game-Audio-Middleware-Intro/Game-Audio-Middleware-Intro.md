...
slug: game-audio-middleware-intro
---
...
![Download AK Launcher](Download-AK-Launcher.png)
- 打开 Audiokinetic Launcher，注册账号并登录，选择版本号，点击 Install
![AK Launcher Install Wwise 01](AK-Launcher-Install-Wwise-01.png)
- Packages 中选择 Authoring（就是指 Wwise），Deployment Platforms 中选择 Microsoft，其他自行按需选择
![AK Launcher Install Wwise 02](AK-Launcher-Install-Wwise-02.png)
- 考虑到部分插件需要 License，简化起见，初次安装可以不勾选任何插件，等之后需要时再添加
![AK Launcher Install Wwise 03](AK-Launcher-Install-Wwise-03.png)
- 安装完成
![AK Launcher Install Wwise 04](AK-Launcher-Install-Wwise-04.png)