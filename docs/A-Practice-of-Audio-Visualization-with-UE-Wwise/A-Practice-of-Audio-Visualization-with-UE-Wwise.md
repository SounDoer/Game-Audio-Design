...
![Waveform & Meter](WaveformAndMeter.png)
...
![UE Blueprint Audio Visualization](UE_Blueprint_Overview.png)
...
![Wwise Meter RTPC](Envelope_Wwise_Meter_RTPC.png)
...
![UE Update Envelope Line](Envelope_UE_UpdateEnvelopeLine.png)

Envelope 效果如下动图。

![Audio Visualization Envelope Demo](Envelope_Demo.gif)
...
![UE Audio Synesthesia](Spectrum_Synesthesia_ConstantQNRT_Object.png)
...
![UE Audio Synesthesia Native Audio Component](Spectrum_Synesthesia_NativeAudioComp.png)
...
![UE Audio Synesthesia Wwise Control](Spectrum_Synesthesia_WwiseControl.png)

Spectrum 效果如下动图。

![Audio Visualization Spectrum Demo](Spectrum_Demo.gif)
...
![UE BP Spectrogram Overview](Spectrogram_UE_Overview.png)
...
![UE Spectrogram Matrix Initial](Spectrogram_SpectrogramMatrixInitial.png)

![UE BP Spawn Spectrogram Matrix](Spectrogram_UE_SpawnSpectrogramMatrix.png)
...
![UE BP Update Spectrogram](Spectrogram_UE_UpdateSpectrogram.png)

Spectrogram 效果如下动图。

![Audio Visualization Spectrogram Demo](Spectrogram_Demo.gif)
